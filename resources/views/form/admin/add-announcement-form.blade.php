                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="title" type="text"
                                           ...
                                           value="{{ trim(old('title')) }}" required autocomplete="title" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea id="description" type="text"
                                              ...
                                              autofocus>{{trim(old('description'))}}</textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="phone_number" type="text"
                                           ...
                                           name="phone_number" value="{{ trim(old('phone_number')) }}" required
